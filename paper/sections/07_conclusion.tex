...
(AUC$=$0.928$\pm$0.041); D-DiffTS on N-BaIoT achieves AUC$=$0.660$\pm$0.427,
as the 310-sample training set is insufficient for the generative model to
learn a robust benign distribution ($\geq$500 samples required based on
CICIoT2023 scaling).
