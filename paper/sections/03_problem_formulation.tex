...
We use ``hard negative'' to denote stealth-controlled proximity to
the benign boundary (high cosine similarity, Eq.~\ref{eq:stealth}),
not model-loss-based difficulty in the online hard-example-mining
sense~\cite{shrivastava2016ohem}.
A more precise term is \emph{stealth-controlled analytical negatives};
we retain ``hard negatives'' for brevity while acknowledging this
distinction.
