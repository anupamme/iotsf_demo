...
eight-baseline ladder, and no cell meets our
prespecified criterion for harmful encoder adaptation: at these seed counts 2 of 31 favour
...
advantage is a statement about the benchmark}.
...
%
% Round 8: that disclaimer -- "we do not claim that drift is generally unpredictive across backbones,
% which three cannot establish" -- is now CUT, and the comment above is the reason it could not be cut
% before. "Nothing else in the body says which reading we decline" stopped being true this round: the
% Ethics Statement's "What we do not claim" list enumerates five such readings, this one among them as
% item (ii), and \S\ref{sec:intro}'s scope paragraph points a reader at the list by name. So the reading
% is still declined, in more detail, one pointer away and on a page ICLR does not count -- and the two
% printed lines it frees are two of the six the round's other edits cost. If that list is ever removed
% from the Ethics Statement, this sentence has to come back here.
