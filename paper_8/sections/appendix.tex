...
% Moved here from S7 for page room. It belongs beside the threshold sweep in any case: the two tables
% are the same eight cells, one per-cell and one swept over the operating point.
\begin{table}[ht]
\centering
