...
We ran 3 seeds (42/101/123) matching the layer-unfreeze set.

\textbf{Results (seeds 42/101/123):}
...
\midrule
Mean$\pm$std & $0.467{\pm}0.079$ & & & $-0.061{\pm}0.151$ & \\
\bottomrule
\end{tabular}
\end{center}

Across 3 seeds: $\Delta R^2{=}{-}0.061{\pm}0.151$ (2/3 negative).
...
None of the 3 random-init seeds approaches the pre-trained condition~B mean
...
The random-init mean $\Delta R^2{=}{-}0.061$ is scattered around zero
