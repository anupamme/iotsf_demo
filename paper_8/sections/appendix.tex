...
Moirai-Small has 12 transformer layers.
...
$N{=}12$ (full unfreeze, condition~B).
...
\textbf{$N{=}3$ results.}
Table~\ref{tab:layerunfreeze} shows results for $N{=}0$, $N{=}3$ (3 seeds), and $N{=}12$ (3 matching seeds).

\begin{table}[h!]
\centering
\vspace{-4pt}
\caption{Layer-wise unfreeze profile (ETTh2 $n{=}10$k, $h{=}96$; mean$\pm$std over seeds).
$N$ = number of top transformer layers unfrozen. $N{=}0$: 5 seeds; $N{=}3$/$N{=}12$: seeds 42/101/123.}
...
1 (top-1)    & 1/12  & $\approx$0.72 (ep.\ 11) & \multicolumn{2}{c}{\textit{diverged (NaN)}} \\
3 (top-3)    & 3/12  & $0.698{\pm}0.066$ & $+0.479{\pm}0.115$ (\textbf{3/3}) & $+1.3{\pm}2.1$\% \\
12 (full, B) & 12/12 & $0.484{\pm}0.061$ & $+0.626{\pm}0.378$ (\textbf{3/3}) & $-7.7{\pm}8.4$\% \\
\bottomrule
\end{tabular}
\vspace{-2pt}
\end{table}
...
\textbf{Finding.}
$\Delta R^2{>}0$ appears already at $N{=}3$ (3/3 seeds), with less encoder
drift (CKA$\approx$0.70) than full unfreeze (CKA$\approx$0.48).
The top-3 layers are sufficient to produce the relative decodability gain;
the remaining 9 frozen layers contribute additional drift without consistently
increasing $\Delta R^2$ (mean $+0.63$ vs.\ $+0.48$, but with larger variance
$0.378$ vs.\ $0.115$).  Both $N{=}3$ and $N{=}12$ operate in the same
deeply-negative-$R^2$ regime ($R^2(\text{ZS}) \approx -6.9$); the same
probe-design robustness established in Appendix~\ref{app:noisefloor} applies.
