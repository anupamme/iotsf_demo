...
\S\ref{sec:analysis:ili} calls it a case study and not a pillar.  \emph{(c)}~Two
...
\S\ref{sec:analysis:ili} reports, and the prospective value-gate predictor, which
...
% PENDING: when the positive control lands, this last sentence takes a
% \ref{sec:exp4:poscontrol}. Written without the ref rather than with a forward one, because a
% known-dangling \ref makes "0 undefined references" stop being a gate that means anything.
