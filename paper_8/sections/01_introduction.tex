...
4 of the 31 reverse sign; and \emph{none} shows decisive evidence of harmful
adaptation under either form of the \S\ref{sec:method} definition, four of the
seven survivors being \emph{improved} by full fine-tuning in every seed.  \textbf{(b)}~The same 31 cells as CKA against
